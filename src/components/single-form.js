...
// Make sure appname works
// Make sure locale works in paypal
// Make sure locale works in stripe
// Make sure locale works in signup
// Make sure errors work
// Make sure locale works with paypal's locale quirks
    ...
    return (
      <div className="container">
        ...
        <div className="payment-section">
          ...
          <ErrorMessage error="generic error be broken"/>
        </div>
      </div>
    );
  }
